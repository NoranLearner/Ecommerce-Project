                                                    ...
                                                    <div class="product-reviews">
                                                        ...
                                                        <div id="product_comments_block_extra">
                                                            ...
                                                            <div class="comments_advices">
                                                                <a href="#" class="comments_advices_tab">
                                                                    <i class="fa fa-comments"></i> Read reviews (1)
                                                                </a>
                                                                <a class="open-comment-form" data-toggle="modal" data-target="#new_comment_form" href="#">
                                                            ...
                                                            @isset($product -> categories)
                                                                <div>
                                                                    @foreach($product -> categories as $category )
                                                                        <span>
                                                                            <a href="{{route('category',$category -> slug )}}" title="Computer &amp; Networking">
                                                                                {{$category -> name}}
                                                                            </a>
                                                                        </span>
                                                                    @endforeach
                                                        ...
                                                        <form id="id_new_comment_form" action="#">
                                                            ...
                                                            <div class="product row no-gutters">
                                                                ...
                                                                <div class="product_desc col-8">
                                                                    <p class="product_name">Nullam sed sollicitudin mauris</p>
                                                            ...
                                                            <div class="new_comment_form_content">
                                                                ...
                                                                <label for="comment_title"> Title for your review
                                                                    <sup class="required">*</sup>
                                                                </label>

                                                                <input id="comment_title" name="title" type="text" value="">

                                                                <label for="content"> Your review
                                                                    <sup class="required">*</sup>
                                                                </label>
                                            ...
                                            <div class="block_content">
                                                ...
                                                <div class="policy-row d-flex">
                                                    <div class="icon-policy">
                                                        <i class="noviconpolicy noviconpolicy-1">1</i>
                                                    </div>
                                                ...
                                                <div class="policy-row d-flex">
                                                    <div class="icon-policy">
                                                        <i class="noviconpolicy noviconpolicy-2">2</i>
                                                    </div>
                                                    <div class="policy-content">
                                                ...
                                                <div class="policy-row d-flex">
                                                    <div class="icon-policy">
                                                        <i class="noviconpolicy noviconpolicy-3">3</i>
                                                    </div>
                                                    <div class="policy-content">
                    ...
                    <div class="product-detail-bottom">
                        ...
                        <div class="container">
                            ...
                            <section class="relate-product product-accessories clearfix">
                                ...
                                <h3 class="h5 title_block"> Related products
                                    <span class="sub_title">Hand-picked arrivals from the best designer</span>
                                </h3>
                                            ...
                                            <div class="product-cat-content">
                                                ...
                                                <div class="category-title">
                                                    ...
                                                    <div class="product-title" itemprop="name">
                                                        <a href="{{route('product.details',$_product -> slug)}}">{{$_product -> name}}</a>
                                                    </div>
                                                    ...
                                                    <div class="product-groups">
                                                        ...
                                                        <div class="product-group-price">
                                                            ...
                                                            <div class="product-price-and-shipping">
                                                                ...
                                                                <span itemprop="price" class="price">{{$_product -> special_price ?? $_product -> price }}</span>
                                                ...
                                                <div class="product-buttons d-flex justify-content-start"
                                                    ...
                                                    <a class="addToWishlist  wishlistProd_22" href="#" data-product-id="{{$_product -> id}}" ></a>

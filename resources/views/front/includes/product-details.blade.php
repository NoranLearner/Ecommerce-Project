    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-product-id="{{ $product->id }}" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="col-md-7 col-sm-7">
                        ...
                        <div class="product-actions">
                            ...
                            <form action="" method="post" id="add-to-cart-or-refresh">
                                ...
                                <div class="product-add-to-cart in_border">
                                    ...
                                    <p class="product-minimal-quantity mt-20"> </p>
                        ...
                        <div class="dropdown social-sharing">
                            <button class="btn btn-link" type="button" id="social-sharingButton"
                                ...
                                <span>
                                    <i class="fa fa-share-alt" aria-hidden="true"></i> Share With :
                                </span>
                            </button>

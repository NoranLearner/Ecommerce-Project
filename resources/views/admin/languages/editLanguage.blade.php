                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$language -> name}}" id="name" class="form-control" placeholder="ادخل اسم اللغة" name="name">
                                                            @error('name')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$language -> abbr}}" id="name" class="form-control" placeholder="ادخل أختصار اللغة" name="abbr">
                                                            @error('abbr')
                                                            <span class="text-danger">{{$message}} </span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            <input type="checkbox" value="1" name="active" id="switcheryColor4" class="switchery" data-color="success" @if($language -> active  == 1 ) checked @endif/>
                                                            @error('active')
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>

                                        ...
                                        <table class="table display nowrap table-striped table-bordered scroll-horizontal">
                                            ...
                                            @isset($vendors)
                                                @foreach($vendors as $vendor)
                                                    <tr>
                                                        <td>{{$vendor -> name}}</td>
                                                        <td> <img src="{{$vendor -> logo}}" alt="" style="width: 100px; height: 100px;"> </td>
                                                        <td>{{$vendor -> mobile}}</td>
                                                        <!-- Use Relationship in Vendor Model -->
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <a href="{{ route( 'admin.vendors.edit', $vendor -> id ) }}" class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1"> تفعيل </a>

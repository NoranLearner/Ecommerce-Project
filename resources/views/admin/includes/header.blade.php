                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                            ...
                            <span>
                                <i class="ficon ft-flag"> </i>
                            </span>

                        </a>

                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right" style="width: 12rem;">
                            ...
                            <li class="dropdown-menu-header">
                                ...
                                <span class="notification-tag badge badge-default badge-info float-right m-0" style="font-weight: bolder;">{{App::getLocale()}}</span>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-left">
                                            ...
                                            <span class="avatar avatar-sm avatar-busy rounded-circle">
                                                ...
                                                <img src="{{asset('assets/admin/images/portrait/small/avatar-s-2.png')}}" alt="avatar">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-left">
                                            ...
                                            <span class="avatar avatar-sm avatar-online rounded-circle">
                                                ...
                                                <img src="{{asset('assets/admin/images/portrait/small/avatar-s-3.png')}}" alt="avatar">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-left">
                                            ...
                                            <span class="avatar avatar-sm avatar-away rounded-circle">
                                                ...
                                                <img src="{{asset('assets/admin/images/portrait/small/avatar-s-6.png')}}" alt="avatar">

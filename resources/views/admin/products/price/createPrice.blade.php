                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">سعر المنتج
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> سعر المنتج </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{route('admin.products.price.store')}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"> <i class="ft-home"></i> سعر المنتج </h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" value="{{old('special_price_start')}}" id="special_price_start" class="form-control" placeholder="" name="special_price_start">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" value="{{old('special_price_end')}}" id="special_price_end" class="form-control" placeholder="" name="special_price_end">

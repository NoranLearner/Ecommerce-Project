                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> صور المنتج </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{route('admin.products.images.store.db')}}" method="POST" enctype="multipart/form-data">

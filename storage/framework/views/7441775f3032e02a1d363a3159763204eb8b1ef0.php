        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-lg-9 col-md-9 header-menu d-flex align-items-center justify-content-end">
                ...
                <div class="data-contact d-flex align-items-center">
                    ...
                    <div class="title-icon"> support
                        <i class="icon-support icon-address"></i>
                    </div>

                    <div class="content-data-contact">
                        <div class="support">Call customer services :</div>
                        <div class="phone-support"> 1234 567 899 </div>
                    </div>
                ...
                <div class="contentsticky_group d-flex justify-content-end">
                    ...
                    <div class="header_link_myaccount">
                        <a class="login" href="login-1.html" rel="nofollow" title="Log in to your customer account">
                            <i class="header-icon-account"></i>
                        </a>
                    </div>

                    <div class="header_link_wishlist">
                        <a href="<?php echo e(route('wishlist.products.index')); ?>" title="My Wishlists">
                    ...
                    <div id="_desktop_cart">
                        ...
                        <div class="blockcart cart-preview active" data-refresh-url="">
                            ...
                            <div class="header-cart">
                                ...
                                <div class="cart-left">
                                    <a href="<?php echo e(route('site.cart.index')); ?>" title="My Wishlists">
...
<?php /**PATH /opt/lampp/htdocs/Ecommerce/resources/views/front/includes/header-center.blade.php ENDPATH**/ ?>
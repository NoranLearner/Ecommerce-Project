                                                ...
                                                <?php if(isset($category -> childrens)): ?>
                                                    ...
                                                    <div class="dropdown-menu" style="width:222px">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <?php $__currentLoopData = $category -> childrens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <ul class="menu level1">
                                    ...
                                    <li class="item home-page has-sub">
                                        ...
                                        <div class="dropdown-menu" style="width:200px">
                                            <ul class="">
                                                <li class="item ">
                                                    <a href="index-4.htm?home=home_1" title="Homepage 1"> Homepage 1 </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="index-5.htm?home=home_2" title="Homepage 2"> Homepage 2 </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="index.htm?home=home_3" title="Homepage 3"> Homepage 3 </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="index-6.htm?home=home_4" title="Homepage 4"> Homepage 4 </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="index-7.htm?home=home_5" title="Homepage 5"> Homepage 5 </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="index-8.htm?home=home_6" title="Homepage 6"> Homepage 6 </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="index-9.htm?home=home_7" title="Homepage 7"> Homepage 7 </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="index-10.htm?home=home_8" title="Homepage 8"> Homepage 8 </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li class="item  has-sub">
                                        ...
                                        <div class="dropdown-menu" style="width:270px">
                                            <ul class="">
                                                <li class="item ">
                                                    <a href="index.php.html?fc=module&amp;module=smartblog&amp;id_post=14&amp;controller=details" title="Blog detail">
                                                        Blog detail
                                                    </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="/savemart/blog.html?index.php&cateblog_layout=layout-left-column&cateblog_type=list&cateblog_columns=1" title="Category Blog ( Left column)">
                                                        Category Blog ( Left column)
                                                    </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="/savemart/blog.html?index.php&cateblog_layout=layout-right-column&cateblog_type=list&cateblog_columns=1" title="Category Blog ( Right column)">
                                                        Category Blog ( Right column)
                                                    </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="/savemart/blog.html?index.php&cateblog_layout=layout-one-column&cateblog_type=grid&cateblog_columns=1" title="Category Blog ( One column)">
                                                        Category Blog ( One column)
                                                    </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="/savemart/blog.html?index.php&cateblog_layout=layout-one-column&cateblog_type=grid&cateblog_columns=3" title="Category Blog ( Grid  column )">
                                                        Category Blog ( Grid column )
                                                    </a>
                                                </li>
                                                <li class="item ">
                                                    <a href="/savemart/blog.html?index.php&cateblog_type=list&cateblog_columns=1&cateblog_layout=layout-one-column" title="Category Blog List">
                                                        Category Blog List
                                                    </a>
                                                </li>
                                            </ul>
                                    ...
                                    <li class="item menu-page group">
                                        ...
                                        <a href="sitemap.html?controller=sitemap" title="Pages">
                                            <i class="zmdi zmdi-assignment"></i> Pages
                                        </a>
                                                        ...
                                                        <ul class="">
                                                            ...
                                                            <li class="item col-md-3 mw-20 html">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul class="col">
                                                                        <li><a href="3-computer-networking.html">Category Layout Grid</a></li>
                                                            ...
                                                            <li class="item col-md-3 mw-20 html">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_1">
                                                                                Left Column
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_2">
                                                                                Right Column
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_3">
                                                                                Left Thumbnail
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_4">
                                                                                Right Thumbnail
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_5">
                                                                                Outside Thumbnail
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_7">
                                                                                Sticky Image Thumbnail 1
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_6">
                                                                                Sticky Image Thumbnail 2
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="/savemart/index.php?id_product=1&id_product_attribute=2&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_8">
                                                                                Detail Without Sidebar
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            ...
                                                            <li class="item col-md-3 mw-20 html">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="/savemart/en/index.php?controller=page-not-found">
                                                                                404 Page
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="/savemart/index.php?controller=contact">
                                                                                Contact Us Page
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="/savemart/index.php?id_cms=4&controller=cms">
                                                                                About Us Page
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                            ...
                                                            <li class="item col-md-3 mw-40 html">
                                                                <div class="menu-content">
                                                                    <div class="menu-banner-3 text-center">
                                                                        <a href="#">
                                                                            <img class="img-fluid" src="img/mega-menu-3.jpg" alt="mega-menu-3.jpg">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <ul class="">
                                                            ...
                                                            <li class="item  html">
                                                                <div class="menu-content">
                                                                    <div class="row">
                                                                        <div class="col-12 col-lg-4 col-md-4 mt-xs-10 text-center">
                                                                            <a href="#">
                                                                                <img class="img-fluid" src="img/banner-mega-1.jpg" alt="menu-banner-1">
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-4 col-lg-4 col-md-4 mt-xs-10 text-center">
                                                                            <a href="#">
                                                                                <img class="img-fluid" src="img/banner-mega-2.jpg" alt="menu-banner-2">
                                                                            </a>
                                                                        </div>
                                                                        <div
                                                                            class="col-4 col-lg-4 col-md-4 mt-xs-10 text-center">
                                                                            <a href="#">
                                                                                <img class="img-fluid" src="img/banner-mega-3.jpg" alt="menu-banner-3">
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<?php /**PATH /opt/lampp/htdocs/Ecommerce/resources/views/front/includes/header-bottom.blade.php ENDPATH**/ ?>
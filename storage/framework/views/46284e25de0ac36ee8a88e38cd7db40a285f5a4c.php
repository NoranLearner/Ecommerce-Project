...
<head>
    ...
    <link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo e(asset('assets/front/img/favicon.ico')); ?>?1531456858">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('assets/front/img/favicon.ico')); ?>?1531456858">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/front/themes/vinova_savemart/assets/cache/theme-78026624.css')); ?>" type="text/css" media="all">
...
<?php /**PATH /opt/lampp/htdocs/Ecommerce/resources/views/layouts/site.blade.php ENDPATH**/ ?>